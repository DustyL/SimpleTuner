#!/bin/bash
# ============================================
# FLUX.2 LyCORIS LoKr Training Script - FAST
# Optimized for Single B300 GPU (275GB VRAM)
# High batch size, short training run
# ============================================
...
# Configuration paths
export ACCELERATE_CONFIG_FILE="config/flux2-dlay-b300-fast/accelerate_config.yaml"
export CONFIG_PATH="config/flux2-dlay-b300-fast/config.json"
...
echo "=============================================="
echo "SimpleTuner - FLUX.2 LyCORIS LoKr FAST Training"
echo "=============================================="
echo "Subject: DLAY man persona"
echo "Hardware: Single B300 GPU (275GB VRAM)"
echo "Dataset: /root/DATASETS/DLAY/subject (269 images)"
echo "Output: /root/output/simpletuner-flux2-dlay-lokr-fast"
echo ""
echo "OPTIMIZED SETTINGS:"
echo "  - Batch size: 40 (maximizing VRAM)"
echo "  - Max steps: 500 (~2.5 epochs)"
echo "  - Learning rate: 1e-4 (2x higher)"
echo "  - Warmup: 50 steps (10%)"
...
echo "Output saved to: /root/output/simpletuner-flux2-dlay-lokr-fast"
echo "=============================================="
